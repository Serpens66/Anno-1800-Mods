...
if g_LuaScriptBlockers[ModID]==nil then
    ...
    g_LuaTools.modlog("checkmodlog_incompatible.lua registered",ModID)
    ...
    if g_shared_PopUp_Serp==nil then
      ...
      g_LuaTools.modlog("checkmodlog_incompatible.lua ERROR: g_shared_PopUp_Serp is missing!",ModID)
    end
    ...
    if incompatible_string ~="" then
      ...
      g_LuaTools.modlog("incompatible mods detected, showing PopUp now",ModID)
