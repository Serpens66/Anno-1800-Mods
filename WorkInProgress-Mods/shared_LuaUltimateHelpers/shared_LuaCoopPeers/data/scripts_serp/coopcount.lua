...
-- (or any of the other functions from the bottom of this script)
...
-- TODO:
 -- für CoopCount die alte Version mit den Ressourcen wiederherstellen,
  -- aber mit hinweis, dass es LuaHelper mod gibt,
   -- der deutlich mehr kann (aber eben mit dem nachteil des sessionladens beim savegameladen)
  -- und die meisten coopcount funktionen von hier packen wir dann in cooppeers mod rein, weil sie nur mit den infos von ort funktionieren
