...
-- Converting eg "true" to true. and "g_AnnoTools.modlog" to function (only knows global variables)
...
if g_AnnoTools==nil then -- also start this, so its enough to call one of it on your script
