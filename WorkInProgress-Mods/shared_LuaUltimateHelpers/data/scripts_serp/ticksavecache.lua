...
if g_ObjectFinderSerp~=nil then
  g_AnnoTools.start_thread("SaveCache",ModID,g_ObjectFinderSerp.t_SaveCache) -- the function itself makes sure only the correct peer finally executes the save
end