...
g_LuaTools.start_thread("lu_session_entered.lua","",function()
  ...
  g_LuaTools.CallGlobalFnBlocked("g_ObjectFinderSerp.OnIslandSettledSessionEnter",SessionGuid,5000,PID)
end)
