...
-- TODO:
 ...
 -- TODO:
  -- evtl. doch mit ts.Selection.Object.ItemContainer.SetCheatItemInSlot(1500001245,1) RewardPool arbeiten?
   -- scheint ja doch zu gehen und ohne desync? Vorsichtshalber nochmal im MP testen
...
if g_LuaScriptBlockers[ModID]==nil then
    ...
    local function t_DoSupportFleet(PID,TargetPID,IsThirdParty,last_QID,fleetname,buyingships)
      ...
      for OID,objinfo in pairs(fakeships) do
        ...
        if userdata~=nil then
          ...
          -- TODO test ob funzt und obs desynced
          -- evtl. dann rewards aus quest weglassen
          ts.GetGameObject(OID).ItemContainer.SetCheatItemInSlot(1500001245,1)
    ...
    g_SupportFleet_Serp = {
      ...
      -- TODO Airships für Nate zufügen (und Nate gibt nichts anderes)
      ShipsToSpawn = {
