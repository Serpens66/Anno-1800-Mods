...
for HumanPID in range(4): # 0 bis 3
  ...
  GUIDs = []
  for i in range(12): # 0 bis 11 ACHTUNG: Anzahl an GUIDs in Datei prüfen und hier anpassen
    GUIDs.append(CurrentGUID)
    CurrentGUID += 1
  ...
  finalcode = tree_str.format(HumanName=HumanName,HumanPID=HumanPID,
    ...
    GUID_8=GUIDs[7],GUID_9=GUIDs[8],GUID_10=GUIDs[9],GUID_11=GUIDs[10],GUID_12=GUIDs[11],
